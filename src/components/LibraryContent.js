...
const LibraryContent = () => {
  return (
    <section className="box-border w-full flex flex-col items-start justify-start pt-[30px] px-0 pb-7 max-w-full shrink-0 text-left text-13xl text-gray-400 font-nunito border-b-[1px] border-solid border-silver-100">
      <div className="flex flex-row  items-center justify-between max-w-full gap-[80px] mq1300:flex-wrap">
        <div className="flex flex-col items-start justify-center gap-[10px] max-w-full">
          ...
          <h3 className="m-0 relative text-sm font-normal font-inherit text-gray-300 mq450:text-base">
