...
function Sidebar() {
  ...
  useEffect(() => {
    ...
    } else if (location.pathname == '/libraries') {
  ...
  return (
    <div className="h-[1070px] w-[326px] rounded-xl bg-white flex flex-col items-start justify-start p-5 box-border gap-[35px] max-w-full mq450:gap-[17px]">
      ...
      <div className="self-stretch flex-1 flex flex-col items-start justify-start text-left text-base text-gray-400 font-nunito">
        <div 
        className={`self-stretch rounded-mini ${currentTab=='home' && 'bg-linen'}  flex flex-row items-start justify-start p-[15px] gap-[10px] top-[0] z-[99]`}
        onClick={onNewChatLightClick}
        >
          <img
        ...
        <div
          className={`self-stretch rounded-mini ${currentTab=='activity' && 'bg-linen'} flex flex-row items-start justify-start p-[15px] gap-[10px] cursor-pointer font-outfit`}
        ...
        <div
          className={`self-stretch h-[54px] rounded-mini overflow-hidden ${currentTab=='libraries' && 'bg-linen'} shrink-0 flex flex-col items-start justify-start gap-[12px] cursor-pointer text-white`}
        ...
        >
          ...
          >
            <MenuItem value={1} onClick={(e)=>{
              setLib(1)}}>Library 1</MenuItem>
            <MenuItem value={2} onClick={(e)=>{
              setLib(2)}}>Library 2</MenuItem>
            <MenuItem value={3} onClick={(e)=>{
              setLib(3)}}>Library 3</MenuItem>
