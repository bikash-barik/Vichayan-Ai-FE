  ...
  return (
    <>
      <div className="w-full relative bg-grey-base-2 overflow-hidden flex flex-row flex-wrap items-start justify-start p-[5px] box-border leading-[normal] tracking-[normal] [row-gap:20px] text-left text-base text-gray-400 font-nunito">
        ...
        <main className="flex-1 rounded-xl bg-grey-base-2 overflow-hidden flex flex-col items-center justify-start pt-[104px] px-5 pb-[35px] box-border relative gap-[25px] min-w-[1030px] max-w-full lg:pt-[68px] lg:pb-[23px] lg:box-border lg:min-w-full mq750:pt-11 mq750:pb-5 mq750:box-border">
          <div className="w-[732px] h-[842px] overflow-y-auto shrink-0 flex flex-col items-start justify-start pt-[275px] px-0 pb-0 box-border gap-[70px] max-w-full lg:pt-[179px] lg:box-border mq750:h-auto mq750:gap-[35px] mq450:gap-[17px] mq450:pt-[75px] mq450:box-border mq1050:pt-[116px] mq1050:box-border">
            <ChatLight
              propMarginTop="-1274px"
              propDisplay="unset"
              propMinWidth="unset"
              propDisplay1="unset"
              propMinWidth1="unset"
          ...
          <ChatBoxLight1
            propAlignSelf="unset"
            propWidth="732px"
            onChatBoxLightClick={onChatBoxLightClick}
          />
          <FrameComponent4 />
        </main>
      </div>
